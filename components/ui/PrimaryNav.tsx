...
export default function PrimaryNav({}) {
  ...
  const ulStyles = "bg-black/10 dark:bg-white/10 flex glass items-center gap-6 px-6 py-2 rounded-full transition-all";
  const ulStackedStyles = "flex flex-col glass gap-2 px-6 py-2 transition-all";
